...
--
-- Host: localhost
-- Generation Time: 2017 年 10 月 26 日 13:22
...
(13, 'ハイパージーズ', 166, '0022', '東京都杉並区久我山３−１', '202', 77000, 3000, 1, 1, '', '1LDK', 'オーナー所有', 'minimini@yahoo.co.jp', '', '', '', '', 'ミニミニ浜田山', '', '', '', '', '', '2017年10月25日 1時10分', 0, 0, 0, 1, 0, '', '', '', '', '', '', '', '', '', '', '', '', '2017年10月28日', '2017年11月03日', 'クリーニング'),
...
(19, 'ハイパージーズ', 166, '0022', '東京都杉並区久我山３−１', '203', 78000, 3000, 1, 1, '', '1K', 'オーナー所有', 'minimini@yahoo.co.jp', '', '', '', '', 'ミニミニ浜田山', '', '', '', '', '', '2017年10月24日 15時29分', 0, 1, 0, 1, 0, 'エイブル', '', '', '', '', '', '', '', '', '', '', '', '2017年11月17日', '', ''),
(21, 'ジーズプラチナ', 107, '0064', '東京都港区北青山３−１', '3-E', 110000, 10000, 2, 2, '', '1DK', '現地エントランス横　keybox「0331」', 'g\'s@gmail.com', 'akasaka@yahoo.co.hp', 'every@co.jp', '', '', 'ジーズ不動産', '赤坂不動産', 'エブリー不動産', '', '', '', '2017年10月25日 0時50分', 1, 0, 0, 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '2017年10月28日', '和室を洋室に変更\r\nキッチンを新品に\r\n浴室乾燥機を追加\r\nウォシュレットに変更'),
...
(29, 'ジーズプラチナ', 107, '0064', '東京都港区北青山３−１', '1-C', 110000, 10000, 2, 2, '', '1R', '現地エントランス横　keybox「0331」', 'g\'s@gmail.com', 'akasaka@yahoo.co.hp', 'every@co.jp', '', '', 'ジーズ不動産', '赤坂不動産', 'エブリー不動産', '', '', '', '2017年10月25日 0時41分', 0, 1, 0, 0, 1, 'エイブル', '', '', '', '', '', '', '', '', '', '', '', '', '2017年10月28日', '和室を洋室に変更\r\nキッチンを新品に\r\n浴室乾燥機を追加\r\nウォシュレットに変更\r\nフローリングへ'),
(30, 'ハイパージーズ', 166, '0022', '東京都杉並区久我山３−１', '204', 78000, 3000, 1, 1, '', '1R', 'オーナー所有', 'minimini@yahoo.co.jp', '', '', '', '', 'ミニミニ浜田山', '', '', '', '', '', '2017年10月24日 16時01分', 0, 0, 0, 0, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '2017年10月27日', 'クリーニング'),
...
--
ALTER TABLE `estate`
  MODIFY `code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;COMMIT;
